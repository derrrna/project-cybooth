    ...
    return(
        <div className={'flex'}>
            <div className={'overflow-hidden w-screen h-screen'}>
                ...
                {/*TODO:fix this issue*/}
                <div className={"hidden lg:flex w-full h-full z-[-37]"}>
                    <DynamicImage imageSource={"Flower2.png"} originalScale={'scale-50'} imageStyle={'-rotate-90'}/>
                    <DynamicImage imageSource={"Flower2.png"} originalScale={'scale-50'} scaleUp={'scale-60'}/>
                </div>
            </div>
